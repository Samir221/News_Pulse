import 'package:newspulse_ui/src/shared/app_colors.dart';
import 'package:newspulse_ui/src/shared/styles.dart';
...
class BoxText extends StatelessWidget {
  ...
  BoxText.body(this.text,
      {Color color = kcMediumBlueColor, TextAlign align = TextAlign.start})
